...
var appRoutes = [{ path: 'home', component: _home_home_component__WEBPACK_IMPORTED_MODULE_5__["HomeComponent"] },
    { path: 'portfolio', component: _portfolio_portfolio_component__WEBPACK_IMPORTED_MODULE_6__["PortfolioComponent"] },
    { path: 'view/:name/:occupation/:age/:country/:Email/:url', component: _view_view_component__WEBPACK_IMPORTED_MODULE_7__["ViewComponent"] }];
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            imports: [
                _angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forRoot(appRoutes), _angular_http__WEBPACK_IMPORTED_MODULE_3__["HttpModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_8__["AppRoutingModule"]
            ],
            providers: [],
...
module.exports = "div{\r\n    height: 500px;\r\n    width: 800px;\r\n    background-image: url(\"https://firebrandtalent.com/wp-content/uploads/portfolio1.jpg\");\r\n    margin: 10px;\r\n}"
...
module.exports = "<div class=\"container\">\n<div *ngFor='let portfolio of dataArr' \n[routerLink]=\"['/view',portfolio.name,portfolio.occupation,\nportfolio.age,portfolio.country,portfolio.Email,portfolio.url]\">\n<div class=\"boxes\">\n  {{portfolio.name}}\n  <hr>\n  <img src=\"{{portfolio.url}}\">\n</div>\n</div>\n</div>\n"
...
var PortfolioComponent = /** @class */ (function () {
    function PortfolioComponent(http, route) {
        var _this = this;
        this.http = http;
        this.route = route;
        this.dataArr = [];
        this.http.get('assets/portfolio.json').map(function (response) { return response.json(); })
...
module.exports = "<div class=\"container\">\n<div class=\"div1\">\n  Details of {{Name}}:<br><hr>\n  1.Name:{{Name}}<br>\n  2.Occupation:{{occupation}}<br>\n  3.Email:{{Email}}<br>\n  4.country:{{country}}<br>\n  5.Age:{{age}}\n</div>\n<button (click)=\"goBack()\">Back</button>\n<div class=\"div2\">\n  <img src=\"{{url}}\">\n</div>\n</div>\n"
...
var ViewComponent = /** @class */ (function () {
    function ViewComponent(route, location) {
        this.route = route;
    ...
    ViewComponent.prototype.ngOnInit = function () {
        ...
        this.sub = this.route.params.subscribe(function (params) {
            ...
            _this.occupation = params['occupation'];
...
module.exports = __webpack_require__(/*! C:\Users\sudhiranjan\Desktop\Protek\Angular\PortfolioRouting_ActivatedRoute\src\main.ts */"./src/main.ts");
