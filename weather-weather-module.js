...
/* harmony import */ var _weather_weather_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./weather/weather.component */ "./src/app/weather/weather/weather.component.ts");
...
/* harmony import */ var _weather_routing_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./weather-routing.module */ "./src/app/weather/weather-routing.module.ts");
/* harmony import */ var _weather_weather_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./weather/weather.component */ "./src/app/weather/weather/weather.component.ts");
    ...
    WeatherModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            imports: [
                ...
                _weather_routing_module__WEBPACK_IMPORTED_MODULE_3__["WeatherRoutingModule"], _angular_http__WEBPACK_IMPORTED_MODULE_2__["HttpModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormsModule"]
            ],
            declarations: [_weather_weather_component__WEBPACK_IMPORTED_MODULE_4__["WeatherComponent"]]
        })
    ], WeatherModule);
...
/***/ "./src/app/weather/weather/weather.component.css":
/*!*******************************************************!*\
  !*** ./src/app/weather/weather/weather.component.css ***!
  \*******************************************************/
...
/***/ "./src/app/weather/weather/weather.component.html":
/*!********************************************************!*\
  !*** ./src/app/weather/weather/weather.component.html ***!
  \********************************************************/
/*! no static exports found */
...
var WeatherComponent = /** @class */ (function () {
    ...
    WeatherComponent.prototype.open = function (inp) {
        var _this = this;
        this.http.get('http://api.openweathermap.org/data/2.5/weather?APPID=176e1e176fbd98b6a382a125a210d3de&units=metric&q=' + this.cityName)
            .subscribe(function (res) {
            var weathercity = res.json();
            _this.cityName = inp.value;
            _this.Temperature = weathercity.main.temp;
            _this.Humidity = weathercity.main.humidity;
            _this.pressure = weathercity.main.pressure;
            _this.cel = 'C';
            inp.value = " ";
        });
    };
    WeatherComponent.prototype.validate = function (x, y, z) {
        x.innerText = " ";
        y.innerText = " ";
        z.innerText = " ";
    };
    WeatherComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./weather.component.html */ "./src/app/weather/weather/weather.component.html"),
            styles: [__webpack_require__(/*! ./weather.component.css */ "./src/app/weather/weather/weather.component.css")]
        }),
